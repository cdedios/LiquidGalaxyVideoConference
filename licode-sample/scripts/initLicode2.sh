...
cp $ROOT/erizo_controller/erizoClient/dist/erizo.js $EXTRAS/licode-sample/public/
cp $ROOT/nuve/nuveClient/dist/nuve.js $EXTRAS/licode-sample/

echo [licode] Done, run licode-sample/basicServer.js
